...
This build is configured for npm on Vercel. If an older `pnpm-lock.yaml` remains in your GitHub repository, delete it so Vercel does not infer pnpm. Then redeploy without build cache after replacing the files.
