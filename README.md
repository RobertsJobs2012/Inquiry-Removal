...
- State48-style shared CSS loading so destination pages are not waiting on route CSS chunks
- InstantLink wrapper around Next.js Link to warm routes on viewport, hover, focus, touch, and pointer-down
- Faster route warmup after idle time for key internal pages
...
- Page CSS is intentionally imported through the root layout in this State48-match build. This favors instant navigation over route-level CSS splitting.
