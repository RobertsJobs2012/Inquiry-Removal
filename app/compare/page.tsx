    ...
    <>
      ...
      <main id="main" className="compare-page">
        <PageHero
          ...
          title={
            <>
              We&apos;ve Done the <span className="ir-gradient-text">Inquiry Removal Comparison</span> for You — Honestly, Including Where We Fall Short.
            </>
          }
          subtitle={
            <p>
          ...
          <div className="container">
            <div className="compare-cta-shell">
              ...
              <div className="compare-cta-actions">
                <Link href="/get-started" prefetch="load" className="btn btn-primary">
                  Book My Free Consultation
                </Link>
                <a href="tel:+16023776626" className="btn btn-secondary">
                  Call 602-377-6626
                </a>
              </div>
