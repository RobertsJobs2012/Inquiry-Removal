...
const COMPARISON_ROWS = [
  {
    ...
    inquiryRemoval: "✅ One-time flat fee",
    lexingtonLaw: "❌ Monthly subscription",
    creditSaint: "❌ Monthly subscription",
    creditPeople: "❌ Monthly subscription",
  },
  {
    feature: "Starting Price",
    inquiryRemoval: "✅ $199 one time",
    lexingtonLaw: "❌ $99–$149/month",
    creditSaint: "❌ $79–$129/month",
    creditPeople: "❌ $99/month",
  },
  {
    feature: "Cost After 6 Months",
    inquiryRemoval: "✅ $199–$499 total",
    lexingtonLaw: "❌ $594–$894+",
    creditSaint: "❌ $474–$774+",
    creditPeople: "❌ $594+",
  },
  {
    feature: "Specialization",
    inquiryRemoval: "✅ Hard inquiry removal only",
    lexingtonLaw: "❌ Generalist",
    creditSaint: "❌ Generalist",
    creditPeople: "❌ Generalist",
  },
  {
    feature: "Inquiry Removal Depth",
    inquiryRemoval: "✅ Primary focus — all federal laws applied",
    lexingtonLaw: "⚠️ One item on a checklist",
    creditSaint: "⚠️ One item on a checklist",
    creditPeople: "⚠️ One item on a checklist",
  },
  {
    feature: "Dispute Letters",
    inquiryRemoval: "✅ Custom-built for each inquiry",
    lexingtonLaw: "❌ Template-based",
    creditSaint: "❌ Template-based",
    creditPeople: "❌ Template-based",
  },
  {
    feature: "Bureaus Covered",
    inquiryRemoval: "✅ All 3 simultaneously",
    lexingtonLaw: "✅ All 3",
    creditSaint: "✅ All 3",
    creditPeople: "✅ All 3",
  },
  ...
  },
  {
    ...
    inquiryRemoval: "✅ 100% — 90 days",
    lexingtonLaw: "⚠️ Limited / varies",
    creditSaint: "⚠️ 90-day money back",
    creditPeople: "⚠️ Limited / varies",
  },
  {
    feature: "Defined End Point",
    inquiryRemoval: "✅ Work ends when inquiries are removed",
    lexingtonLaw: "❌ No defined endpoint",
    creditSaint: "❌ No defined endpoint",
    creditPeople: "❌ No defined endpoint",
  },
  {
    feature: "Financial Incentive to Finish Fast",
    inquiryRemoval: "✅ Yes — flat fee, no ongoing billing",
    lexingtonLaw: "❌ No — monthly billing continues",
    creditSaint: "❌ No — monthly billing continues",
    creditPeople: "❌ No — monthly billing continues",
  },
  {
    feature: "Dedicated Specialist",
    inquiryRemoval: "✅ One person assigned to your file",
    lexingtonLaw: "❌ Rotating case workers",
    creditSaint: "❌ Rotating case workers",
    creditPeople: "❌ Rotating case workers",
  },
  {
    feature: "Phone Accessibility",
    inquiryRemoval: "✅ Calls answered directly",
    lexingtonLaw: "❌ Reported call center delays",
    creditSaint: "❌ Reported call center delays",
    creditPeople: "❌ Reported call center delays",
  },
  {
    feature: "Founded",
    inquiryRemoval: "2015",
  ...
  },
  {
    ...
    inquiryRemoval: "✅ 4.9 stars — Google",
    lexingtonLaw: "⚠️ Mixed — varies by platform",
    creditSaint: "⚠️ Mixed — varies by platform",
    creditPeople: "⚠️ Mixed — varies by platform",
  },
];
      ...
      <main id="main" className="compare-page">
        ...
        >
          ...
          <div className="compare-hero-mini-table">
            ...
            <strong>✅ One-time flat fee</strong>
            <span>Specialization</span>
            <strong>✅ Hard inquiry removal only</strong>
            <span>Dispute Letters</span>
            <strong>✅ Custom-built for each inquiry</strong>
            <span>Defined End Point</span>
            <strong>✅ Work ends when inquiries are removed</strong>
          </div>
        </PageHero>
                ...
                <tbody>
                  {COMPARISON_ROWS.map((row) => (
                    <tr key={row.feature}>
                      ...
                      <td className="compare-highlight-col">{row.inquiryRemoval}</td>
                      <td>{row.lexingtonLaw}</td>
                      <td>{row.creditSaint}</td>
                      <td>{row.creditPeople}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
