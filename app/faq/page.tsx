...
const FAQS = [
  ...
  },
  {
    ...
    a: "We have permanently removed over 100,437 hard inquiries across Experian, Equifax, and TransUnion since 2015. We do this using the FCRA, FDCPA, FACTA, and Metro 2 compliance laws — not generic templates, not guesswork. Our review-first qualification standard exists because we know which law applies to which type of inquiry and why. Disputing and removing are the same outcome when you know what you're doing.",
  },
  {
...
export const metadata: Metadata = {
  title: {
    absolute: "Questions We Hear Every Single Day | Inquiry Removal",
  },
  description:
  ...
  openGraph: {
    title: "Questions We Hear Every Single Day | Inquiry Removal",
    description:
      "Answers to common questions about hard inquiry removal, timelines, results, prior credit repair attempts, and whether your situation may qualify.",
    ...
    <>
      ...
      <main id="main" className="faq-page">
        <PageHero
          ...
          title={
            <>
              Questions We Hear Every Single Day
            </>
          }
          subtitle={
            <p>
