    ...
    <>
      ...
      <main id="main" className="services-page">
        <PageHero
          ...
          title={
            <>
              Find the <span className="ir-gradient-text">Inquiry Removal Plan</span> Built for Your Exact Situation
            </>
          }
          subtitle={
            <p>
        ...
        >
          ...
          <Link href="/get-started" prefetch="load" className="btn btn-primary services-hero-cta">
        ...
        <section className="services-by-bureau section-divider" aria-labelledby="services-specialty-heading">
          <div className="container">
            <div className="services-copy-head services-by-bureau-head">
              <h2 id="services-specialty-heading">
                Choose the Landing Page That Matches Your Situation or City
              </h2>
              <p>
                Some hard inquiry problems need a more specific playbook. These
                pages break down the exact removal path for unauthorized pulls,
                identity theft inquiries, dealership pulls, mortgage approval urgency,
                California clients, Phoenix clients, and New York City clients.
              </p>
            </div>
            ...
            <div className="services-bureau-grid">
              ...
              <Link href="/identity-theft-inquiry-removal" className="services-bureau-card services-bureau-card-equifax">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">Identity Theft</span>
                  <h3>Fraudulent Inquiries</h3>
                </div>
                <p>
                  Built for identity theft victims who found hard inquiries
                  from accounts they never opened, companies they never contacted,
                  or lenders in places they have never been.
                </p>
                <span className="services-bureau-card-cta">
                  Identity theft inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>

              <Link href="/unauthorized-hard-inquiry-removal" className="services-bureau-card services-bureau-card-transunion">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">FCRA</span>
                  <h3>Unauthorized Inquiries</h3>
                </div>
                <p>
                  Built for visitors who found a hard inquiry from a company
                  they never authorized, do not recognize, or believe lacked
                  permissible purpose.
                </p>
                <span className="services-bureau-card-cta">
                  Unauthorized inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>

              <Link href="/car-dealership-inquiry-removal" className="services-bureau-card services-bureau-card-experian">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">Situation</span>
                  <h3>Car Dealership Inquiries</h3>
                </div>
                <p>
                  Built for unauthorized dealership pulls, shotgun lender submissions,
                  soft-pull bait and switch situations, and mortgage-pending urgency.
                </p>
                <span className="services-bureau-card-cta">
                  Dealer inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>



              <Link href="/hard-inquiry-removal-mortgage" className="services-bureau-card services-bureau-card-equifax">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">Mortgage</span>
                  <h3>Mortgage Approval</h3>
                </div>
                <p>
                  Built for home buyers whose mortgage approval, closing date,
                  or rate tier is being held back by hard inquiry count.
                </p>
                <span className="services-bureau-card-cta">
                  Mortgage inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>

              <Link href="/los-angeles-hard-inquiry-removal" className="services-bureau-card services-bureau-card-equifax">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">City</span>
                  <h3>Los Angeles</h3>
                </div>
                <p>
                  Localized for LA hard inquiry removal, California consumer protections,
                  dealership pulls, homebuying urgency, and Spanish-speaking clients.
                </p>
                <span className="services-bureau-card-cta">
                  Los Angeles inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>

              <Link href="/phoenix-hard-inquiry-removal" className="services-bureau-card services-bureau-card-transunion">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">Home Market</span>
                  <h3>Phoenix</h3>
                </div>
                <p>
                  Phoenix-focused page built around Robert Garcia&apos;s founder story,
                  Valley dealership pulls, Arizona law, and Maricopa County clients.
                </p>
                <span className="services-bureau-card-cta">
                  Phoenix inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>

              <Link href="/new-york-city-hard-inquiry-removal" className="services-bureau-card services-bureau-card-experian">
                <div className="services-bureau-card-tone" aria-hidden="true" />
                <div className="services-bureau-card-head">
                  <span className="services-bureau-card-eyebrow">City</span>
                  <h3>New York City</h3>
                ...
                <p>
                  Built for NYC apartment applications, employer credit checks,
                  dealership pulls, identity theft inquiries, and all five boroughs.
                </p>
                <span className="services-bureau-card-cta">
                  NYC inquiry removal <span aria-hidden="true">→</span>
                </span>
              </Link>
            </div>
          </div>
        ...
        <section className="services-consult section-divider" aria-labelledby="services-consult-heading">
          <div className="container services-copy-shell">
            ...
            <div className="services-copy-card services-consult-card">
              ...
              <Link href="/get-started" prefetch="load" className="btn btn-primary btn-large services-consult-cta">
          ...
          <div className="container">
            <div className="services-closing-card gradient-border">
              ...
              <div className="services-closing-actions">
                <Link href="/get-started" prefetch="load" className="btn btn-primary btn-large">
                  Get My Free Credit Analysis
                </Link>
