    ...
    <>
      ...
      <main id="main" className="pricing-page">
        <PageHero
          ...
          title={
            <>
              Before We Talk About What This Costs, Let&apos;s Talk About What Your <span className="ir-gradient-text">Hard Inquiries</span> Are Already Costing You.
            </>
          }
          subtitle={
            <p>
