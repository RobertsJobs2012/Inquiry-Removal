...
import { howItWorksPageSchema } from "@/lib/schema";
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(howItWorksPageSchema) }}
      />
      <AnnouncementBar />
      <Navigation />
      <main id="main" className="how-page">
        <PageHero
          ...
          title={
            <>
              Simple Process. Real Results. No Surprises — Here Is Exactly What Happens <span className="ir-gradient-text">When You Work with Us</span>.
            </>
          }
          subtitle={
            <p>
            ...
            <ol className="how-page-steps">
              {STEPS.map((step) => (
                <li key={step.id} id={step.id} className="how-page-step">
                  <div className="how-page-step-rail" aria-hidden="true">
                    <span className="how-page-step-icon">
                      <PremiumIcon name={step.icon} size={20} />
                    </span>
                  </div>
