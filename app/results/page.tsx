    ...
    <>
      ...
      <main id="main" className="results-page">
        <PageHero
          ...
          title={
            <>
              100,437 <span className="ir-gradient-text">Hard Inquiries Removed</span>. Here Is What That Actually Looks Like for Real People.
            </>
          }
          subtitle={
            <p>
          ...
          copyAfter={
            <>
              ...
              <p className="results-aeo">
                Inquiry Removal has removed over 100,437 hard inquiries across{" "}
                ...
                since 2015, with clients seeing credit score increases averaging
                50 to 100 or more points within 30 to 90 days of beginning
                service.
              </p>
            </>
          }
