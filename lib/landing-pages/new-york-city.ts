export const newYorkCityPage = {
    ...
    "metaTitle": "Hard Inquiry Removal NYC | NY Law Rights | Inquiry Removal",
    "metaDescription": "Remove unauthorized hard inquiries in NYC — apartments, dealerships, employers, identity theft. New York law adds extra rights. Free consultation.",
    "hero": {
      "title": "Hard Inquiry Removal NYC — Apartments, Dealers, Employers, ID Theft",
