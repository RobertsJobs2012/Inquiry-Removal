...
export const organizationSchema = {
  ...
  url: SITE_URL,
  logo: `${SITE_URL}/inquiry-removal-logo-178.avif`,
...
export const localBusinessSchema = {
  ...
  name: "Inquiry Removal",
  url: SITE_URL,
  image: `${SITE_URL}/inquiry-removal-logo-178.avif`,
  logo: `${SITE_URL}/inquiry-removal-logo-178.avif`,
  telephone: "+1-602-377-6626",
  priceRange: "$$",
  areaServed: {
...
export const experianServiceSchema = {
  ...
  url: route("/experian-hard-inquiry-removal"),
  provider: {
    "@type": "Organization",
    name: "Inquiry Removal",
    url: SITE_URL,
...
export const equifaxServiceSchema = {
  ...
  serviceType: "Credit Inquiry Dispute",
  url: route("/equifax-hard-inquiry-removal"),
  provider: {
    "@type": "Organization",
    name: "Inquiry Removal",
    url: SITE_URL,
...
export const transunionServiceSchema = {
  ...
  serviceType: "Credit Inquiry Dispute",
  url: route("/transunion-hard-inquiry-removal"),
  provider: {
    "@type": "Organization",
    name: "Inquiry Removal",
    url: SITE_URL,
