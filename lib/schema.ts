...
export const howItWorksPageSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      url: `${SITE_URL}/how-it-works#step-4`,
    },
  ],
};
...
export const pricingPageServiceSchema = {
  ...
  availableChannel: {
    "@type": "ServiceChannel",
    serviceUrl: `${SITE_URL}/get-started`,
...
export const experianServiceSchema = {
  ...
  url: `${SITE_URL}/remove-hard-inquiry-experian`,
  provider: {
    "@type": "Organization",
    name: "Inquiry Removal",
    url: SITE_URL,
...
export const equifaxServiceSchema = {
  ...
  serviceType: "Credit Inquiry Dispute",
  url: `${SITE_URL}/remove-hard-inquiry-equifax`,
  provider: {
    "@type": "Organization",
    name: "Inquiry Removal",
    url: SITE_URL,
...
export const transunionServiceSchema = {
  ...
  serviceType: "Credit Inquiry Dispute",
  url: `${SITE_URL}/remove-hard-inquiry-transunion`,
  provider: {
    "@type": "Organization",
    name: "Inquiry Removal",
    url: SITE_URL,
