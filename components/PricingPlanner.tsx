      ...
      <section className="pricing-roi section-divider" aria-labelledby="pricing-roi-heading">
        <div className="container">
          ...
          <div className="pricing-roi-calculator">
              ...
              {costProjection ? (
                <>
                  <article>
                    ...
                    <strong>{(costProjection.currentRate * 100).toFixed(2)}%</strong>
                  </article>
                  <article>
                    <span>Estimated improved rate</span>
                    <strong>{(costProjection.improvedRate * 100).toFixed(2)}%</strong>
                  </article>
                  <article>
                  ...
                  <article>
                    ...
                    <strong>{formatCurrency(costProjection.savings)}</strong>
                  </article>
                  <article>
                    <span>Inquiry Removal flat fee</span>
                    <strong>{formatCurrency(costProjection.fee)}</strong>
                  </article>
                  <article>
                    <span>Flat fee as % of savings</span>
                    <strong>{costProjection.percentage.toFixed(1)}%</strong>
                  </article>
                </>
              ) : (
            ...
            {costProjection ? (
              <p className="pricing-roi-source-note">
