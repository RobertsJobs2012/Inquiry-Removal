      ...
      <div className="container hero-grid">
        <div className="hero-content">
          <h1 id="hero-heading" className="hero-headline">
            ...
            <span className="gradient-text hero-headline-accent">
              Hard Inquiries
            </span>{" "}
          ...
          <p className="hero-subheadline">
            ...
            <strong>Experian, Equifax, and TransUnion</strong> credit reports —
            using federal law, custom disputes, and 11 years of specialized
            experience — so your score goes back up and you finally get
            approved for what matters most.
          </p>
