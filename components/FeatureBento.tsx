...
const TILES: BentoTile[] = [
  {
    ...
    description: (
      <>
        We dispute directly and simultaneously with{" "}
        ...
        — targeting every unauthorized, excessive, or fraudulent hard inquiry
        across all three reports. Not just one bureau. Not just the obvious
        ones. Every inquiry that doesn&apos;t belong there.
      </>
    ),
