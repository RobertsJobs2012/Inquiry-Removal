    ...
    <section ref={topRef} className="get-started-quiz" aria-labelledby="get-started-heading">
      <div className="container get-started-shell">
        <div className="get-started-copy">
          ...
          <p className="get-started-trust">🔒 {heroTrust}</p>
        </div>
        ...
        <div className="quiz-shell" aria-live="polite">
          {!submitted ? (
                ...
                {currentStep === 6 ? (
                  <>
                    ...
                    <blockquote className="quiz-testimonial">
                      ...
                      <footer>
                        James L. | Chicago, IL ⭐⭐⭐⭐⭐ | 14 Inquiries Removed |
                    ...
                    <p className="quiz-soft-path">
                      ...
                      <a href="tel:6023776626">602-377-6626</a> — Questions
            ...
            <div className="quiz-panel quiz-confirmation">
              <div className="quiz-confirm-badge">✅ You&apos;re In. Here&apos;s What Happens Next.</div>
              ...
              <blockquote className="quiz-testimonial">
                ...
                <footer>
                  Maria S. | San Antonio, TX ⭐⭐⭐⭐⭐ | 22 Inquiries Removed |
                  +88 Points
                </footer>
              </blockquote>
              ...
              <div className="quiz-confirm-links">
                ...
                <div>
                  ...
                  <Link href="/results">📊 Read Client Results →</Link>
                  <Link href="/pricing">💰 Review Pricing Details →</Link>
                </div>
              </div>
