        ...
        <div className="footer-grid">
          ...
          <div className="footer-columns">
            <nav className="footer-nav-col footer-company" aria-label="Company links">
              ...
              <ul>
                {COMPANY_LINKS.map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} prefetch="viewport">{link.label}</Link>
                  </li>
                ))}
              </ul>
            </nav>
            ...
            <section className="footer-start" aria-label="Get started">
              ...
              <Link href="/get-started" prefetch="viewport" className="btn btn-primary footer-primary">
              ...
              <div className="footer-record">
                ...
                <Link href="/results" prefetch="viewport">
          ...
          {LEGAL_LINKS.length > 0 ? (
            <nav className="footer-legal" aria-label="Legal links">
              {LEGAL_LINKS.map((link) => (
                <Link key={link.href} href={link.href} prefetch="viewport">
                  {link.label}
                </Link>
              ))}
            </nav>
