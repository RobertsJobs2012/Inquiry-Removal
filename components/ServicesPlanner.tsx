  ...
  return (
    <>
      <section className="services-plans" aria-labelledby="plans-heading" data-services-planner>
          ...
          <div className="services-plan-grid">
            {PLANS.map((plan) => (
              ...
              >
                ...
                <Link href="/get-started" prefetch="load" className="btn btn-primary btn-large service-plan-cta">
                  {plan.cta}
                </Link>
              </article>
            ))}
        ...
        <script type="module" data-astro-rerun="" dangerouslySetInnerHTML={{ __html: SERVICES_PLANNER_SCRIPT }} />
      </section>
</>
  );
}
